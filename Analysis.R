...
# STEP 3B -----------------------------------------------
# Create yearly greenspace variables: Recode land use to formal/informal grouping

#Add columns with formal/informal codes in one column and the string name in another
##1990
...
g1990_80th_l$CATEGORY_t = ifelse(g1990_80th_l$GreenType == 1, "Formal", 
                               ifelse(g1990_80th_l$GreenType == 2, "Informal",
                                      "ERROR"))
...
g2000_80th_l$CATEGORY_t = ifelse(g2000_80th_l$GreenType == 1, "Formal", 
                               ifelse(g2000_80th_l$GreenType == 2, "Informal",
                                      "ERROR"))
...
g2010_80th_l$CATEGORY_t = ifelse(g2010_80th_l$GreenType == 1, "Formal", 
                               ifelse(g2010_80th_l$GreenType == 2, "Informal",
                                      "ERROR"))
...
g2015_80th_l$CATEGORY_t = ifelse(g2015_80th_l$GreenType == 1, "Formal", 
                               ifelse(g2015_80th_l$GreenType == 2, "Informal",
                                      "ERROR"))
...
#1 = "Formal",2 = "Informal"
oldnames = c('1','2')
newnames = c('FormGreenSqM','InfGreenSqM')
...
summary1990_NDVI80th_w$GreenSqM = summary1990_NDVI80th_w$FormGreenSqM + summary1990_NDVI80th_w$InfGreenSqM
summary2000_NDVI80th_w$GreenSqM = summary2000_NDVI80th_w$FormGreenSqM + summary2000_NDVI80th_w$InfGreenSqM
summary2010_NDVI80th_w$GreenSqM = summary2010_NDVI80th_w$FormGreenSqM + summary2010_NDVI80th_w$InfGreenSqM
summary2015_NDVI80th_w$GreenSqM = summary2015_NDVI80th_w$FormGreenSqM + summary2015_NDVI80th_w$InfGreenSqM
...
# pctA_parkG = % of census tract covered by formal greenspace
MT_1990_G80th$pctA_parkG = MT_1990_G80th$FormGreenSqM/MT_1990_G80th$areaSqM 
MT_2000_G80th$pctA_parkG = MT_2000_G80th$FormGreenSqM/MT_2000_G80th$areaSqM 
MT_2010_G80th$pctA_parkG = MT_2010_G80th$FormGreenSqM/MT_2010_G80th$areaSqM 
MT_2015_G80th$pctA_parkG = MT_2015_G80th$FormGreenSqM/MT_2015_G80th$areaSqM 

# pctA_infG = % of census tract covered by informal greenspace
MT_1990_G80th$pctA_infG = MT_1990_G80th$InfGreenSqM/MT_1990_G80th$areaSqM 
MT_2000_G80th$pctA_infG = MT_2000_G80th$InfGreenSqM/MT_2000_G80th$areaSqM 
MT_2010_G80th$pctA_infG = MT_2010_G80th$InfGreenSqM/MT_2010_G80th$areaSqM 
MT_2015_G80th$pctA_infG = MT_2015_G80th$InfGreenSqM/MT_2015_G80th$areaSqM 

# STEP 4 -----------------------------------------------
# Add final variables to the megatract 

#Replace NAs with 0s for greenspace and census variables
MT_1990_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                     'pctA_infG')][is.na(MT_1990_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                                                              'pctA_infG')])] = 0
MT_2000_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                     'pctA_infG')][is.na(MT_2000_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                                                              'pctA_infG')])] = 0
MT_2010_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                     'pctA_infG')][is.na(MT_2010_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                                                              'pctA_infG')])] = 0
MT_2015_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                     'pctA_infG')][is.na(MT_2015_G80th@data[c('income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h','pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
                                                              'pctA_infG')])] = 0
...
keep = c('cluster_id','YEAR','areaSqM','income','income_inf','rent','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h',
         'pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','GreenSqM','pctA_G','pctA_parkG',
         'pctA_infG')
...
keep2 = c('cluster_id','income_inf','rent_inf','pct_w','pct_cedu','hous_tot','hmVal_inf','pct_v','pct_h',
         'pct_h30','pct_b','ppl_sqm','FormGreenSqM','InfGreenSqM','pctA_G','pctA_parkG','pctA_infG')
...
#Formal greenspace
DF$pctC_formG90_00 = (DF$pA_prkG00 - DF$pA_prkG90)
#Binary formal greenspace
#1 means "increased from the beginning year". 0 means not increased or decreased.
DF$BpctC_formG90_00 = DF$pctC_formG90_00 > 0
DF$BpctC_formG90_00 = as.integer(DF$BpctC_formG90_00)

#Informal greenspace
DF$pctC_infG90_00 = (DF$pA_infG00 - DF$pA_infG90)
#Binary informal greenspace
DF$BpctC_infG90_00 = DF$pctC_infG90_00 > 0
DF$BpctC_infG90_00 = as.integer(DF$BpctC_infG90_00)
...
#Formal greenspace
DF$pctC_formG00_10 = (DF$pA_prkG10 - DF$pA_prkG00)
#Binary formal greenspace
#1 means "increased from the beginning year". 0 means not increased or decreased.
DF$BpctC_formG00_10 = DF$pctC_formG00_10 > 0
DF$BpctC_formG00_10 = as.integer(DF$BpctC_formG00_10)

#Informal greenspace
DF$pctC_infG00_10 = (DF$pA_infG10 - DF$pA_infG00)
#Binary informal greenspace
DF$BpctC_infG00_10 = DF$pctC_infG00_10 > 0
DF$BpctC_infG00_10 = as.integer(DF$BpctC_infG00_10)
...
#Formal greenspace
DF$pctC_formG10_15 = (DF$pA_prkG15 - DF$pA_prkG10)
#Binary formal greenspace
#1 means "increased from the beginning year". 0 means not increased or decreased.
DF$BpctC_formG10_15 = DF$pctC_formG10_15 > 0
DF$BpctC_formG10_15 = as.integer(DF$BpctC_formG10_15)

#Informal greenspace
DF$pctC_infG10_15 = (DF$pA_infG15 - DF$pA_infG10)
#Binary informal greenspace
DF$BpctC_infG10_15 = DF$pctC_infG10_15 > 0
DF$BpctC_infG10_15 = as.integer(DF$BpctC_infG10_15)
...
write.csv(DF, 'C:/Users/mstuhlm1/Dropbox/Envt Gentrification/Data/Combined/DF4JiEun_v7_80th_woNeigh.csv')
...
model90_00_GE = glm(gent90_00 ~ BpctC_formG90_00 + BpctC_infG90_00 + dwntwnM + trnstDistM + B_pctV90_00 + B_pctHUD90_00 + B_pplSqM90_00 +
                      B_pct30H90_00 + pA_prkG90 + pA_infG90, family = "binomial", data = DF_GE90)
...
#1990-2000 Change Model with binary greenspace, % change variables replaced with binary increase. 
model90_00GE_R = glm(gentSDR90_00 ~ BpctC_formG90_00 + BpctC_infG90_00 + dwntwnM + trnstDistM + B_pctV90_00 + B_pctHUD90_00 + B_pplSqM90_00 +
                       B_pct30H90_00 + pA_prkG90 + pA_infG90, family = "binomial", data = DF_GE90)

summary(model90_00GE_R, digits = 3)
OddsRatio(model90_00GE_R)
...
#1990-2000 Change Model with binary greenspace, % change variables replaced with binary increase. 
model00_10_GE = glm(gent00_10 ~ BpctC_formG00_10 + BpctC_infG00_10 + dwntwnM + trnstDistM + B_pctV00_10 + B_pctHUD00_10 + B_pplSqM00_10 +
                      B_pct30H00_10 + pA_prkG00 + pA_infG00, family = "binomial", data = DF_GE00)
...
#1990-2000 Change Model with binary greenspace, % change variables replaced with binary increase. 
model00_10_GE_R = glm(gentSDR00_10 ~ BpctC_formG00_10 + BpctC_infG00_10 + dwntwnM + trnstDistM + B_pctV00_10 + B_pctHUD00_10 + B_pplSqM00_10 +
                        B_pct30H00_10 + pA_prkG00 + pA_infG00, family = "binomial", data = DF_GE00)
...
model10_15_GE = glm(gent10_15 ~ BpctC_formG10_15 + BpctC_infG10_15 + dwntwnM + trnstDistM + B_pctV10_15 + B_pctHUD10_15 + B_pplSqM10_15 +
                      B_pct30H10_15 + pA_prkG10 + pA_infG10, family = "binomial", data = DF_GE10)
...
#2010-2015 Change Model with binary greenspace, % change variables replaced with binary increase
model10_15_GE_R = glm(gentSDR10_15 ~ BpctC_formG10_15 + BpctC_infG10_15 + dwntwnM + trnstDistM + B_pctV10_15 + B_pctHUD10_15 + B_pplSqM10_15 +
                        B_pct30H10_15 + pA_prkG10 + pA_infG10, family = "binomial", data = DF_GE10)
