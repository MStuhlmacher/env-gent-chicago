//GOAL: determine the amount and type of greenspace by census tract for 2010

//STEPS: 
//Calculate NDVI using 2010 Landsat imagery
...
var l5 = ee.ImageCollection("LANDSAT/LT05/C01/T1"),
    ...
    LU2010 = ee.FeatureCollection("users/mfstuhlmacher/EnvGentChicago/CMAPLandUse2010_MT_parkCorrected");  //from CMAP, see Appendix R notebook for park correction

//--Calculate NDVI--//
var dateRange = ee.DateRange('2010-06-01', '2010-08-31');
...
// print(fc);
var sc = ee.Image('LANDSAT/LT05/C01/T1/LT05_022031_20100617').select('B2').projection().nominalScale();
print(sc,"scale");
var crs = ee.Image('LANDSAT/LT05/C01/T1/LT05_022031_20100617').select('B2').projection().crs(); 
print(crs,"crs");
...
//Add the LANDUSE_n_n as a band to the NDVI area image
...
function toDictionary(cur, prev){
  var key = ee.String("LANDUSE_n").cat(ee.String(ee.Dictionary(cur).get('LANDUSE_n'))); //get the LANDUSE_n_n class
...
Export.table.toDrive({
  ...
  description: "LU2010_NDVI70thPer_L5",
  folder:"EnvGentChicago",
  fileNamePrefix: "LU2010_NDVI70thPer_L5",
  fileFormat:  "CSV",
  ...
  "LANDUSE_n6100","LANDUSE_n6200","LANDUSE_n6300","LANDUSE_n6400","LANDUSE_n9999"]
});

Export.table.toDrive({
  collection: output75th,
  description: "LU2010_NDVI75thPer_L5",
  folder:"EnvGentChicago",
  fileNamePrefix: "LU2010_NDVI75thPer_L5",
  fileFormat:  "CSV",
  selectors: ["cluster_id","LANDUSE_n1111","LANDUSE_n1112","LANDUSE_n1130","LANDUSE_n1140","LANDUSE_n1151","LANDUSE_n1211",
  "LANDUSE_n1212","LANDUSE_n1214","LANDUSE_n1215","LANDUSE_n1216","LANDUSE_n1220","LANDUSE_n1240","LANDUSE_n1250","LANDUSE_n1310",
  "LANDUSE_n1321","LANDUSE_n1322","LANDUSE_n1330","LANDUSE_n1340","LANDUSE_n1350","LANDUSE_n1360","LANDUSE_n1370","LANDUSE_n1410",
...
Export.table.toDrive({
  ...
  description: "LU2010_NDVI80thPer_L5",
  folder:"EnvGentChicago",
  fileNamePrefix: "LU2010_NDVI80thPer_L5",
  fileFormat:  "CSV",
  selectors: ["cluster_id","LANDUSE_n1111","LANDUSE_n1112","LANDUSE_n1130","LANDUSE_n1140","LANDUSE_n1151","LANDUSE_n1211",
  "LANDUSE_n1212","LANDUSE_n1214","LANDUSE_n1215","LANDUSE_n1216","LANDUSE_n1220","LANDUSE_n1240","LANDUSE_n1250","LANDUSE_n1310",
  "LANDUSE_n1321","LANDUSE_n1322","LANDUSE_n1330","LANDUSE_n1340","LANDUSE_n1350","LANDUSE_n1360","LANDUSE_n1370","LANDUSE_n1410",
...
Export.table.toDrive({
  ...
  description: "LU2010_NDVI85thPer_L5",
  folder:"EnvGentChicago",
  fileNamePrefix: "LU2010_NDVI85thPer_L5",
  fileFormat:  "CSV",
  selectors: ["cluster_id","LANDUSE_n1111","LANDUSE_n1112","LANDUSE_n1130","LANDUSE_n1140","LANDUSE_n1151","LANDUSE_n1211",
  "LANDUSE_n1212","LANDUSE_n1214","LANDUSE_n1215","LANDUSE_n1216","LANDUSE_n1220","LANDUSE_n1240","LANDUSE_n1250","LANDUSE_n1310",
  "LANDUSE_n1321","LANDUSE_n1322","LANDUSE_n1330","LANDUSE_n1340","LANDUSE_n1350","LANDUSE_n1360","LANDUSE_n1370","LANDUSE_n1410",
...
Export.table.toDrive({
  ...
  description: "LU2010_NDVI90thPer_L5",
  folder:"EnvGentChicago",
  fileNamePrefix: "LU2010_NDVI90thPer_L5",
  fileFormat:  "CSV",
  selectors: ["cluster_id","LANDUSE_n1111","LANDUSE_n1112","LANDUSE_n1130","LANDUSE_n1140","LANDUSE_n1151","LANDUSE_n1211",
  "LANDUSE_n1212","LANDUSE_n1214","LANDUSE_n1215","LANDUSE_n1216","LANDUSE_n1220","LANDUSE_n1240","LANDUSE_n1250","LANDUSE_n1310",
  "LANDUSE_n1321","LANDUSE_n1322","LANDUSE_n1330","LANDUSE_n1340","LANDUSE_n1350","LANDUSE_n1360","LANDUSE_n1370","LANDUSE_n1410",
